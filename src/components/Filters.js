    ...
    <div className="content">
      <form onSubmit={(e)=>e.preventDefault()}>
        ...
        <div className="form-control">
          <input type="text" name="text" placeholder='search over here' className='search-input' value={text} onChange={updateFilters}/>
        </div>
        {/* end search input */}
        {/* categories */}
        <div className="form-control">
          ...
          <div>
            {categories.map((c,index)=>{
              return <button type='button' key={index} onClick={updateFilters} name='category' className={`${category===c.toLowerCase()?'active':null}`}>
                {c}
              </button>
            })}
          </div>
